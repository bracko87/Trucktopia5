 ...
 * SettingsMenu.tsx
 *
 * Dropdown settings menu used in the top bar / header.
 *
 * This file provides a small navigation-only settings menu that routes to
 * dedicated settings pages (e.g. /settings/inbox) instead of opening modals.
 *
 * The component is intentionally self-contained and minimal so header imports
 * can pick it up regardless of import path.
 */
 ...
 * SettingsMenu
 *
 * Renders a settings icon button that toggles a dropdown with links to the
 * dedicated settings pages. Each entry navigates to the corresponding route
